class_name ChooseCapitalUpgradeMessage
extends RefCounted
...
var message_type: StringName = GameMessages.CHOOSE_CAPITAL_UPGRADE
var command_id: String
var issued_at_tick: int
var capital_unit_entity_id: String
...
func _init(
		...
		p_capital_unit_entity_id: String = "",
...
func to_payload() -> Dictionary:
	return {
		...
		"capital_unit_entity_id": capital_unit_entity_id,
...
func from_payload(payload: Dictionary) -> void:
	...
	capital_unit_entity_id = payload.get("capital_unit_entity_id", "")
...
func validate() -> PackedStringArray:
	...
	if capital_unit_entity_id.is_empty():
		errors.append("capital_unit_entity_id is required.")
