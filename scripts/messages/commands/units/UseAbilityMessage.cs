...
public partial class UseAbilityMessage : MessageBase, CommandInterface, QueueableCommandInterface
{
    ...
    public UseAbilityMessage(string p_player_id = "", int p_issued_at_tick = -1, string[] p_caster_entity_ids = default, string p_ability_id = "", int p_queue_mode = (int)GameMessages.QueueMode.REPLACE, string p_target_entity_id = "", Variant p_target_position = default)
    {
