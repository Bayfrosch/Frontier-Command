...
public partial class GatherResourcesMessage : MessageBase, CommandInterface, QueueableCommandInterface
{
    ...
    public GatherResourcesMessage(string p_command_id = "", int p_issued_at_tick = -1, string[] p_harvester_entity_ids = default, string p_resource_field_entity_id = "", int p_queue_mode = (int)GameMessages.QueueMode.REPLACE, string p_refinery_entity_id = "")
    {
    ...
    {
        var payload = D(("command_id", command_id), ("issued_at_tick", issued_at_tick), ("queue_mode", queue_mode), ("harvester_entity_ids", harvester_entity_ids), ("resource_field_entity_id", resource_field_entity_id));
