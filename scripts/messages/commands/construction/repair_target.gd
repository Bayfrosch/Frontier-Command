class_name RepairTargetMessage
extends RefCounted
...
var message_type: StringName = GameMessages.REPAIR_TARGET
var command_id: String
var issued_at_tick: int
var queue_mode: int = GameMessages.QueueMode.REPLACE
var repair_unit_ids: PackedStringArray
...
func from_payload(payload: Dictionary) -> void:
	...
	repair_unit_ids = payload.get("repair_unit_ids", PackedStringArray())
...
func validate() -> PackedStringArray:
	...
	if repair_unit_ids.is_empty():
		errors.append("repair_unit_ids must contain at least one unit.")
