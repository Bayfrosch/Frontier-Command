class_name CancelStructureUpgradeMessage
extends RefCounted
...
var message_type: StringName = GameMessages.CANCEL_STRUCTURE_UPGRADE
var command_id: String
var issued_at_tick: int
var structure_entity_id: String
var upgrade_queue_item_id: String
...
func _init(
		...
		p_upgrade_queue_item_id: String = "",
) -> void:
...
func to_payload() -> Dictionary:
	return {
		...
		"upgrade_queue_item_id": upgrade_queue_item_id,
	}
...
func from_payload(payload: Dictionary) -> void:
	...
	upgrade_queue_item_id = payload.get("upgrade_queue_item_id", "")
...
func validate() -> PackedStringArray:
	...
	if upgrade_queue_item_id.is_empty():
		errors.append("upgrade_queue_item_id is required.")
	return errors
