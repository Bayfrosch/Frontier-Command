...
public partial class UpgradeStructureMessage : MessageBase, CommandInterface
{
    ...
    public UpgradeStructureMessage(string p_command_id = "", int p_issued_at_tick = -1, string p_structure_entity_id = "", string p_upgrade_definition_id = "")
    {
    ...
    public override GDictionary to_payload() => D(("command_id", command_id), ("issued_at_tick", issued_at_tick), ("structure_entity_id", structure_entity_id), ("upgrade_definition_id", upgrade_definition_id));
