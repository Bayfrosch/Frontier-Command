...
public partial class CancelStructureUpgradeMessage : MessageBase, CommandInterface
{
    ...
    public CancelStructureUpgradeMessage(string p_player_id = "", int p_issued_at_tick = -1, string p_structure_entity_id = "", string p_upgrade_queue_item_id = "")
    {
    ...
    public override GDictionary to_payload() => D(("player_id", player_id), ("issued_at_tick", issued_at_tick), ("structure_entity_id", structure_entity_id), ("upgrade_queue_item_id", upgrade_queue_item_id));
