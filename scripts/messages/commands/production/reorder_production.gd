class_name ReorderProductionMessage
extends RefCounted
...
var message_type: StringName = GameMessages.REORDER_PRODUCTION
...
func from_payload(payload: Dictionary) -> void:
	...
	new_index = payload.get("new_index", -1)
...
func validate() -> PackedStringArray:
	...
	if new_index < 0:
		errors.append("new_index cannot be negative.")
	return errors
