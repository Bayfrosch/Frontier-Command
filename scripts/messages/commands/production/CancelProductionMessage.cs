...
public partial class CancelProductionMessage : MessageBase, CommandInterface
{
    ...
    public CancelProductionMessage(string p_command_id = "", int p_issued_at_tick = -1, string p_producer_entity_id = "", string p_queue_item_id = "")
    {
    ...
    public override GDictionary to_payload() => D(("command_id", command_id), ("issued_at_tick", issued_at_tick), ("producer_entity_id", producer_entity_id), ("queue_item_id", queue_item_id));
