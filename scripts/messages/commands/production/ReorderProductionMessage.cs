...
public partial class ReorderProductionMessage : MessageBase, CommandInterface
{
    ...
    public ReorderProductionMessage(string p_player_id = "", int p_issued_at_tick = -1, string p_producer_entity_id = "", string p_queue_item_id = "", int p_new_index = -1)
    {
    ...
    public override GDictionary to_payload() => D(("player_id", player_id), ("issued_at_tick", issued_at_tick), ("producer_entity_id", producer_entity_id), ("queue_item_id", queue_item_id), ("new_index", new_index));
